...
namespace LipSyncLite
{
    ...
    public class LipSyncEditor : Editor
    {
        ...
        public override void OnInspectorGUI()
        {
            ...
            {
                //targetLipSync.dead = EditorGUILayout.FloatField("Audio Noise Reduction:", targetLipSync.dead);
                EditorGUILayout.PropertyField(serializedObject.FindProperty("dead"));
