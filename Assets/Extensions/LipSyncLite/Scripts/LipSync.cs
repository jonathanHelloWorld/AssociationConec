...
{
    [RequireComponent(typeof(CM_MicInput))]
    public class LipSync : GenericView 
    {
        #region Fields
        public static string[] vowelsJP = { "a", "i", "u", "e", "o" };
        public static string[] vowelsCN = { "a", "e", "i", "o", "u", "v" };
        public static string[] vowelsGN = { "a", "i", "e", "u", "o" };
        public float[] vowelFormantFloorGN = { 0, 150.0f, 200.0f, 340.0f, 700.0f };
        ...
        public ERecognizerLanguage recognizerLanguage = ERecognizerLanguage.Generic;
        ...
        protected override void OnUpdate()
        {
            ...
            {
                recognizeResult = runtimeRecognizer.RecognizeByAudioSource(audioSource, dead, vowelFormantFloorGN);
